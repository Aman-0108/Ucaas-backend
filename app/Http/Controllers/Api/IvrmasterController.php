    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make(
            ...
            [
                ...
                'greet_long' => 'nullable|exists:sounds,id,type,ivr',
                'greet_short' => 'nullable|exists:sounds,id,type,ivr',
                'invalid_sound' => 'nullable|exists:sounds,id,type,ivr',
                'exit_sound' => 'nullable|exists:sounds,id,type,ivr',
