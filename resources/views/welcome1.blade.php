...
$esl = event_socket::create('192.168.1.65', 8021, 'ClueCon');
echo '<pre>';
print($esl->request('api status'));


// echo '<br>';
// echo '<pre>';
// print($esl->request('api show command'));
// echo '<br>';
// echo '<pre>';
// print($esl->request('api list_users'));
//print($esl->request('api system date'));
//echo "<br>";
// echo shell_exec('systeminfo /FO CSV 2> nul');
